...
def main() -> None:
    ...
    checks = [
        ...
        result(
            ...
            "TRACE_VB_ARTIFACT_ROOT=/disk1/dingxukai/TRACE/trace_vb_v4_runs"
            in common
            and "role_semantic_runs" not in all_formal_scripts,
            "Every formal output is isolated under trace_vb_v4_runs.",
        ),
        result(
        ...
        result(
            ...
            and "TRACE-VB-v4 forbids saved-tensor CPU activation offload"
            in model
    ...
    report = {
        ...
        "artifact_root": "/disk1/dingxukai/TRACE/trace_vb_v4_runs",
