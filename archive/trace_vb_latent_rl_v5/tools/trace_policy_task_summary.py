...
def write_markdown(path: Path, report: dict):
    lines = [
        ...
        "test sets. Total #L is eight latent states plus every generated "
        "compact-equation and answer token.",
        "",
...
def main():
    ...
    report = {
        ...
        "test_times": 1,
        "total_L_definition": (
            "8 latent states + all generated compact-equation and answer tokens"
        ),
        "datasets": summaries,
