...
def main() -> None:
    ...
    checks = [
        ...
        result(
            ...
            "TRACE_VB_ARTIFACT_ROOT=/disk1/dingxukai/TRACE/trace_vb_v3_runs"
            in common
            and "role_semantic_runs" not in all_formal_scripts,
            "Every formal output is isolated under trace_vb_v3_runs.",
        ),
        result(
        ...
        result(
            ...
            "Answer decoding reads the raw question plus COMMIT, never the private role states.",
        ),
        result(
            "simplified_stage1",
        ...
        result(
            "epoch1_failure_gate",
            "TRACE_VB_EPOCH1_MIN_ACCURACY=0.50" in common
        ...
        result(
            ...
            and "TRACE-VB-v3 forbids saved-tensor CPU activation offload"
            in model
    ...
    report = {
        ...
        "artifact_root": "/disk1/dingxukai/TRACE/trace_vb_v3_runs",
