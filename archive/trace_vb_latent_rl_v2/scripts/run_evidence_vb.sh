...
if checkpoint.get("trace_vb_schema_version") != "trace_vb_v3":
    raise SystemExit("evidence requires a question+COMMIT TRACE-VB-v3 checkpoint")
keys = tuple(checkpoint.get("state_dict", {}))
for fragment in ("trajectory_policy.", "plan_forecaster", "solve_text_decoder.", "sufficiency_head"):
